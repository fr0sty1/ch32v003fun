...
// Instruments are defined elsewhere
...
extern AL_Instrument audio_instrument_4octave_sine;
...
extern AL_Instrument audio_instrument_hihat;
extern AL_Instrument audio_instrument_snare;
extern AL_Instrument audio_instrument_cymbol;
extern AL_Instrument audio_instrument_tom;
extern AL_Instrument audio_instrument_flute;
extern AL_Instrument audio_instrument_sax;
extern AL_Instrument audio_instrument_xylophone;

// Structure to describe an instrument for this playback example
typedef struct {
	AL_Instrument *pInstrument;
	char *name;
